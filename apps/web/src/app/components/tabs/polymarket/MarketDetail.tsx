...
import {
  Activity, X, BarChart3, ExternalLink, RefreshCw, Star,
} from 'lucide-react';
import {
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 6, flexShrink: 0 }}>
            ...
            {onAddToWatchlist && onRemoveFromWatchlist && (
              <button
                ...
                style={{ background: isInWatchlist ? `${C.orange}33` : 'transparent', border: `1px solid ${C.orange}`, color: C.orange, cursor: 'pointer', padding: '3px 6px', fontFamily: C.font, fontSize: 9, borderRadius: 2, display: 'flex', alignItems: 'center', gap: 3 }}
              >
                <Star size={12} fill={isInWatchlist ? C.orange : 'transparent'} />
