...
export function useUSTreasuryData(): UseUSTreasuryDataReturn {
  ...
  const fetchPrices = useCallback(async () => {
    ...
    try {
      ...
      const parsed = parseInvokeResult<TreasuryPricesResponse>(result);
      if (!parsed.success) {
  ...
  const fetchAuctions = useCallback(async () => {
    ...
    try {
      ...
      const parsed = parseInvokeResult<TreasuryAuctionsResponse>(result);
      if (!parsed.success) {
  ...
  const fetchSummary = useCallback(async () => {
    ...
    try {
      ...
      const parsed = parseInvokeResult<TreasurySummaryResponse>(result);
      if (!parsed.success) {
