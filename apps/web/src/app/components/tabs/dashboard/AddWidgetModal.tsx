...
import { X, Plus, Newspaper, BarChart3, Eye, MessageSquare, Bitcoin,
  ...
  BellRing, Cpu, DatabaseZap, Flag, Anchor, Video, Star } from 'lucide-react';
...
const WIDGET_OPTIONS: WidgetOption[] = [
  ...
  { type: 'polymarketwatchlist', label: 'POLYMARKET WATCHLIST', description: 'Your saved Polymarket predictions', icon: <Star size={14} />, color: FC.PURPLE, category: 'analysis' },
