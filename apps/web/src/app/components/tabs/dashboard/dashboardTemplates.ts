...
/** Storage key for user-saved custom dashboard layouts (JSON array of DashboardTemplate-like objects). */
export const CUSTOM_LAYOUTS_STORAGE_KEY = 'dashboard-custom-layouts';
