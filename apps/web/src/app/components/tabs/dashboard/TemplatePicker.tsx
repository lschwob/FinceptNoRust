...
import { Check, X, LayoutGrid, Trash2 } from 'lucide-react';
...
interface TemplatePickerProps {
  ...
  customLayouts?: DashboardTemplate[];
...
export const TemplatePicker: React.FC<TemplatePickerProps> = ({
  ...
  const handleConfirm = () => {
    const tmpl = DASHBOARD_TEMPLATES.find(t => t.id === selected) ?? customLayouts.find(t => t.id === selected);
                    ...
                    >
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '8px' }}>
                        ...
                        {onDeleteCustom && (
                          <button
                            type="button"
                            onClick={(e) => { e.stopPropagation(); onDeleteCustom(tmpl.id); }}
                            ...
                            onMouseEnter={(e) => { e.currentTarget.style.color = FC.RED; }}
                            onMouseLeave={(e) => { e.currentTarget.style.color = FC.GRAY; }}
                          >
                            <Trash2 size={12} />
                          </button>
                        )}
