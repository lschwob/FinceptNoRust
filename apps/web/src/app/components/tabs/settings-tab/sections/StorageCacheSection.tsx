...
import { RefreshCw, Trash2, HardDrive, Database, Plus, Edit2, Save, X, Table2, Loader2 } from 'lucide-react';
        ...
        <>
          <div style={{
            ...
            <div style={{ fontSize: '9px', color: FINCEPT.GRAY }}>
              🔓 <strong style={{ color: FINCEPT.GREEN }}>Local Access Enabled</strong> - Database manager is permanently unlocked in open-source mode
            </div>
          </div>
