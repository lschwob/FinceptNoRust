...
import { TabLoadingFallback, DropdownMenu, HeaderTimeDisplay } from './dashboardComponents';
...
import SwapTab from '@/components/tabs/swap';
...
function FinxeptTerminalContent() {
  ...
  const navigateMenuItems = [
    ...
    { label: 'SWAP (EUR rates)', action: () => setActiveTab('swap') },
  ...
  return (
    <div style={{
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab} className="h-full">
              <TabsList style={{
                ...
                <TabsTrigger
                  ...
                  title="Markets (F2)"
                >
                  {t('navigation.markets', 'Markets')}
                </TabsTrigger>
                <TabsTrigger
                  value="swap"
                  style={activeTab === 'swap' ? tabStyles.active : tabStyles.default}
                  title="SWAP (EUR rates & IRD)"
                >
                  {t('navigation.swap', 'SWAP')}
                </TabsTrigger>
                <TabsTrigger
                  value="trading"
                ...
                >
                  {t('navigation.backtesting', 'Backtesting')}
                </TabsTrigger>
                <TabsTrigger
                  value="algo-trading"
      ...
      {/* Main Content Area with Tab Content — scrollable so all pages are accessible */}
      <div style={{
        flex: 1,
        backgroundColor: '#000000',
        minHeight: 0,
        ...
        {mode === 'chat' ? (
          ...
          <Tabs value={activeTab} className="h-full">
            ...
            <TabsContent value="swap" className="h-full m-0 p-0">
              <SwapTab />
            </TabsContent>
